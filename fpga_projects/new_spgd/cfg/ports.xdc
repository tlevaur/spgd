...
set_property PACKAGE_PIN M15 [get_ports {led_o[2]}]
set_property PACKAGE_PIN N15 [get_ports {led_o[3]}]
...
set_property PACKAGE_PIN H15 [get_ports {led_o[7]}]
