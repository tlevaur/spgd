...
# IP: bd/system/ip/system_SPGD_SYS_0/system_SPGD_SYS_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_SPGD_SYS_0 || ORIG_REF_NAME==system_SPGD_SYS_0} -quiet] -quiet

# IP: bd/system/ip/system_ADC_fp_0/system_ADC_fp_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_ADC_fp_0 || ORIG_REF_NAME==system_ADC_fp_0} -quiet] -quiet

# IP: bd/system/ip/system_fp_DAC_0_0/system_fp_DAC_0_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_fp_DAC_0_0 || ORIG_REF_NAME==system_fp_DAC_0_0} -quiet] -quiet

# IP: bd/system/ip/system_fp_DAC_1_0/system_fp_DAC_1_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_fp_DAC_1_0 || ORIG_REF_NAME==system_fp_DAC_1_0} -quiet] -quiet
