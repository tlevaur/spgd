...
# module references:
# ADC_fp, SPGD_SYS, fp_DAC, fp_DAC, ADC_REG
...
proc create_hier_cell_PS7 { parentCell nameHier } {
  ...
  connect_bd_net -net SPGD_SYS_GP_OUT [get_bd_pins gpio2_io_i] [get_bd_pins axi_gpio_0/gpio2_io_i]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: ADC_fp, and set properties
  set block_name ADC_fp
  set block_cell_name ADC_fp
  if { [catch {set ADC_fp [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ADC_fp eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: SPGD_SYS, and set properties
  set block_name SPGD_SYS
  set block_cell_name SPGD_SYS
  if { [catch {set SPGD_SYS [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $SPGD_SYS eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: fp_DAC_0, and set properties
  set block_name fp_DAC
  set block_cell_name fp_DAC_0
  if { [catch {set fp_DAC_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $fp_DAC_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: fp_DAC_1, and set properties
  set block_name fp_DAC
  set block_cell_name fp_DAC_1
  if { [catch {set fp_DAC_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $fp_DAC_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create port connections
  connect_bd_net -net ADC_REG_a_data_out [get_bd_pins ADC_BLOCK/a_data_out] [get_bd_pins ADC_fp/ADC_A]
  connect_bd_net -net ADC_REG_adc_clk [get_bd_pins ADC_BLOCK/adc_clk] [get_bd_pins ADC_fp/ADC_CLK] [get_bd_pins SPGD_SYS/ADC_CLK]
  connect_bd_net -net ADC_REG_b_data_out [get_bd_pins ADC_BLOCK/b_data_out] [get_bd_pins ADC_fp/ADC_B]
  connect_bd_net -net ADC_fp_ADC_16Q48_OUT [get_bd_pins ADC_fp/ADC_16Q48_OUT] [get_bd_pins SPGD_SYS/ADC_IN]
  connect_bd_net -net ADC_fp_ADC_DONE [get_bd_pins ADC_fp/ADC_DONE] [get_bd_pins SPGD_SYS/ADC_DONE]
  connect_bd_net -net SPGD_SYS_ADC_EN [get_bd_pins ADC_fp/ADC_EN] [get_bd_pins SPGD_SYS/ADC_EN]
  connect_bd_net -net SPGD_SYS_ADC_SEL [get_bd_pins ADC_fp/ADC_SEL] [get_bd_pins SPGD_SYS/ADC_SEL]
  connect_bd_net -net SPGD_SYS_DAC_A_OUT [get_bd_pins SPGD_SYS/DAC_A_OUT] [get_bd_pins fp_DAC_0/fp_in]
  connect_bd_net -net SPGD_SYS_DAC_B_OUT [get_bd_pins SPGD_SYS/DAC_B_OUT] [get_bd_pins fp_DAC_1/fp_in]
  connect_bd_net -net SPGD_SYS_GP_OUT [get_bd_pins PS7/gpio2_io_i] [get_bd_pins SPGD_SYS/GP_OUT]
  connect_bd_net -net SPGD_SYS_LED_O [get_bd_ports led_o] [get_bd_pins SPGD_SYS/LED_O]
  connect_bd_net -net SPGD_SYS_REG_RESET [get_bd_pins ADC_fp/REG_RST] [get_bd_pins SPGD_SYS/REG_RESET]
  connect_bd_net -net SPGD_SYS_val_0 [get_bd_ports dac_spi_clk_o] [get_bd_ports dac_spi_csb_o] [get_bd_ports dac_spi_reset_o] [get_bd_pins SPGD_SYS/val_0]
  connect_bd_net -net SPGD_SYS_val_1 [get_bd_ports dac_spi_sdio_o] [get_bd_pins SPGD_SYS/val_1]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins PS7/gpio_io_o] [get_bd_pins SPGD_SYS/GP_IN]
  connect_bd_net -net fp_DAC_0_DAC_out [get_bd_ports dac_dat_a_o] [get_bd_pins fp_DAC_0/DAC_out]
  connect_bd_net -net fp_DAC_1_DAC_out [get_bd_ports dac_dat_b_o] [get_bd_pins fp_DAC_1/DAC_out]
